...
class Order(models.Model):
    ...
    # address = models.ManyToManyField('CheckoutDetail')
    # city = models.ManyToManyField('CheckoutDetail' )
    # state = models.ManyToManyField('CheckoutDetail' , on_delete=models.CASCADE, null=True)
